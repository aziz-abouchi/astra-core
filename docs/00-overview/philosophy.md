# Philosophie d’Heaven Core

Heaven Core est un langage conçu pour un monde où les ressources sont limitées,
...
Heaven repose sur un type system expressif, un runtime déterministe, et un modèle
